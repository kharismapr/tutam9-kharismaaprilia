...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
      <div className="container mx-auto py-20 px-4 flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 flex-grow">
        {/* Right Section */}
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <p className="text-lg my-10 pr-10">
